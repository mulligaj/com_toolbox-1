...
class Migration20180605153409ComToolboxTools extends Base
{
	...
	public function up()
	{
		...
		$createTable = "CREATE TABLE $tableName (
			...
			`cost` int(6) NULL DEFAULT NULL,
			`minimum_participants` int(6) NULL DEFAULT NULL,
			`suggested_participants` int(6) NULL DEFAULT NULL,
			`maximum_participants` int(6) NULL DEFAULT NULL,
